-- ============================================================================
-- CHUNK 13 — customer_upload_enabled toggle on applications
-- Admin toggle to explicitly allow the customer to upload documents on /track.
-- When true → upload section appears on /track regardless of status.
-- When false → upload section hidden (unless status implies it, but this flag
