-- ============================================================================
-- CHUNK 12 — Block flag + custom status message on applications
-- Adds:
--   * is_blocked            → when true, /track hides status/details
--   * custom_status_message → free-form status text admin can write
-- Updates lookup_application to expose both fields and gate blocked apps.
-- ============================================================================
...
begin
  ...
  -- Blocked application: return minimal payload so /track can show a
  -- blocked notice without leaking status/history/documents.
