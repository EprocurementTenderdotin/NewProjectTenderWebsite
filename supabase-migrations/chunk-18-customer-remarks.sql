-- ============================================================================
-- CHUNK 18 — Admin-written public remarks visible under Current Status on /track
-- Adds applications.customer_remarks and exposes it via lookup_application.
-- ============================================================================
  ...
  if coalesce(v_app.is_blocked, false) then
    return jsonb_build_object(
      ...
      'app', jsonb_build_object(
        ...
        'customer_remarks', v_app.customer_remarks,
