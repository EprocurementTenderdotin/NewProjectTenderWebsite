-- ============================================================================
-- CHUNK 11 — Fix lookup_application: pgcrypto's digest() not on search_path
-- Symptom: /track always errors "function digest(text, unknown) does not exist"
-- Fix: ensure pgcrypto exists and reference it via the extensions schema.
-- ============================================================================
