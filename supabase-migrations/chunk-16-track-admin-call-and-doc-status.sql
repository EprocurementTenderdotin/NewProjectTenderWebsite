-- ============================================================================
-- CHUNK 16 — Track page payload parity for admin-managed fields
-- Exposes call_scheduled_date, call_status, call_remarks in lookup_application
-- so customer /track shows admin's saved call updates.
-- ============================================================================
